...
$(V_JAEGER)    jaeger-#{VERSION}-linux-#{GOARCH}/jaeger-all-in-one *                                     https://github.com/jaegertracing/jaeger/releases/latest/download/jaeger-#{VERSION}-linux-#{GOARCH}.tar.gz                    %
