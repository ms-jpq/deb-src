...
$(V_CODEX)       codex-app-server-#{HOSTTYPE}-unknown-linux-musl:codex-app-server                   *                                     https://github.com/openai/codex/releases/latest/download/codex-app-server-#{HOSTTYPE}-unknown-linux-musl.tar.gz              %
$(V_CODEX)       codex-code-mode-host-#{HOSTTYPE}-unknown-linux-musl:codex-code-mode-host           *                                     https://github.com/openai/codex/releases/latest/download/codex-code-mode-host-#{HOSTTYPE}-unknown-linux-musl.tar.gz          %
$(V_CODEX)       codex-responses-api-proxy-#{HOSTTYPE}-unknown-linux-musl:codex-responses-api-proxy *                                     https://github.com/openai/codex/releases/latest/download/codex-responses-api-proxy-#{HOSTTYPE}-unknown-linux-musl.tar.gz     %
...
$(V_DIFF_NAV)    diffnav                                                                            *                                     https://github.com/dlvhdr/diffnav/releases/latest/download/diffnav_Linux_#{HOSTTYPE}.tar.gz                                  %aarch64=arm64,amd64=x64
